...
const mc = (id, question, options, correctIndex, explanation) => ({
  id,
...
const tf = (id, question, isTrue, explanation) => ({
  id,
  type: "true-false",
  question,
  options: ["Benar", "Salah"],
...
const fb = (id, question, answer, wrongOptions, explanation) => ({
  id,
  type: "fill-blank",
  question,
    ...
    chapters: [
      {
        ...
        emoji: "📅",
        description: "Kenali fase-fase utama kehidupan manusia dari bayi hingga lansia",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            101,
      ...
      },
      {
        ...
        title: "Perkembangan Fisik",
        emoji: "💪",
        description: "Pahami perubahan fisik yang terjadi di setiap tahap kehidupan",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            201,
      ...
      },
      {
        ...
        title: "Perkembangan Emosional",
        emoji: "❤️",
        description: "Kenali perkembangan emosi dan psikologis di setiap fase kehidupan",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            301,
      ...
      },
      {
        ...
        emoji: "🏥",
        description: "Pelajari cara menjaga kesehatan optimal di setiap tahap kehidupan",
        questionsPerPlay: 3,
        questionPool: [
          tf(
            401,
  ...
  },
  {
    ...
    lembarBalik: [
      ...
      },
      {
        ...
        emoji: "🧠",
        content: "Kematangan emosional meliputi: kemampuan komunikasi asertif, manajemen konflik yang sehat, empati terhadap pasangan, dan komitmen jangka panjang. Konseling pranikah sangat dianjurkan."
      },
      {
        title: "Hak dan Kewajiban Suami Istri",
        emoji: "⚖️",
        content: "Berdasarkan UU Perkawinan, suami berkewajiban memberi nafkah lahir dan batin. Istri berhak atas perlindungan dan pendidikan. Keduanya memiliki hak dan kewajiban yang setara dalam mengasuh anak.",
        highlight: "Pernikahan adalah kemitraan setara berdasarkan rasa hormat dan kasih sayang."
      },
      {
        title: "Dasar Keluarga Berencana",
        emoji: "👨‍👩‍👧",
        content: "KB bukan hanya tentang kontrasepsi, tetapi merencanakan keluarga ideal: jumlah anak, jarak kehamilan, waktu terbaik memulai keluarga. Program BKKBN mendukung keluarga merencanakan masa depan yang lebih baik."
      }
    ],
    chapters: [
      {
        ...
        emoji: "⚖️",
        description: "Kenali aturan hukum pernikahan di Indonesia dan usia ideal menikah",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            101,
      ...
      },
      {
        ...
        emoji: "🧠",
        description: "Persiapkan diri secara fisik, mental, dan finansial sebelum berumah tangga",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            201,
      ...
      },
      {
        ...
        title: "Hak & Kewajiban",
        emoji: "📜",
        description: "Pahami hak dan kewajiban suami istri dalam pernikahan yang sah",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            301,
    ...
    lembarBalik: [
      {
        title: "Siapa PUS?",
        emoji: "👫",
        content: "Pasangan Usia Subur adalah pasangan suami istri dimana istri berusia 15-49 tahun. Pada usia ini, wanita masih dalam masa reproduktif aktif."
      },
      {
        title: "Metode Kontrasepsi",
        emoji: "💊",
        content: "Pilihan KB modern: Pil (diminum harian), Suntik (setiap 1/3 bulan), IUD (3-10 tahun, reversibel), Implan (3-5 tahun), Kondom, MOW/MOP (sterilisasi permanen).",
        highlight: "Konsultasikan pilihan KB dengan tenaga kesehatan untuk hasil terbaik."
      },
      {
        title: "Jarak Ideal Kehamilan",
        emoji: "📅",
        content: "WHO merekomendasikan jarak kehamilan minimal 2-3 tahun. Manfaatnya: ibu memiliki waktu pemulihan optimal, ASI eksklusif dapat diberikan penuh, anak pertama mendapat perhatian lebih."
      },
      {
        title: "Nutrisi Kehamilan",
        emoji: "🥗",
        content: "Ibu hamil memerlukan: Asam folat (mencegah cacat tabung saraf), Zat besi (mencegah anemia), Kalsium (tulang janin), Protein (pertumbuhan janin), dan Vitamin D.",
        highlight: "Nutrisi yang baik sejak awal kehamilan menentukan kesehatan bayi seumur hidup."
      },
      {
        title: "Pemeriksaan Kehamilan (ANC)",
        emoji: "🏥",
        content: "Antenatal Care minimal 4 kali selama kehamilan: trimester 1 (1x), trimester 2 (1x), trimester 3 (2x). Pemeriksaan meliputi tekanan darah, berat badan, tinggi fundus, denyut jantung janin."
      }
    ],
    chapters: [
      {
        ...
        title: "Mengenal PUS",
        emoji: "👫",
        description: "Pahami siapa yang disebut Pasangan Usia Subur dan hak-hak kesehatan reproduksinya",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            101,
      ...
      },
      {
        ...
        emoji: "🤱",
        description: "Pelajari nutrisi dan pemantauan kehamilan yang penting untuk ibu dan bayi",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            301,
      ...
      },
      {
        ...
        emoji: "👶",
        description: "Kenali pentingnya ASI, imunisasi, dan perawatan pasca melahirkan",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            401,
    ...
    lembarBalik: [
      {
        ...
        emoji: "💫",
        content: "Setiap remaja memiliki potensi unik yang perlu dikembangkan. Kenali bakat dan minatmu melalui eksplorasi berbagai kegiatan.",
        highlight: "Kamu memiliki potensi luar biasa yang menunggu untuk dikembangkan!"
      },
      {
        title: "Strategi Belajar Efektif",
        emoji: "📚",
        content: "Tips belajar sukses: Buat jadwal rutin dan konsisten, gunakan teknik Pomodoro (25 menit fokus + 5 menit istirahat), buat ringkasan dengan bahasa sendiri, bergabung dengan kelompok belajar."
      },
      {
        title: "Bahaya Pernikahan Dini",
        emoji: "⚠️",
        content: "Menikah di usia remaja berdampak buruk: putus sekolah, risiko kesehatan akibat kehamilan dini, masalah ekonomi, ketidakstabilan emosional.",
        highlight: "Raih cita-citamu dulu, pernikahan lebih indah jika kamu sudah siap!"
      },
      {
        title: "Menghindari NAPZA dan Pergaulan Bebas",
        emoji: "🚫",
        content: "NAPZA (Narkotika, Psikotropika, Zat Adiktif) merusak otak dan menghancurkan masa depan. Cara menolak: katakan TIDAK dengan tegas, cari lingkungan pertemanan yang positif."
      },
      {
        title: "Membangun Karakter dan Masa Depan",
        emoji: "🌟",
        content: "Karakter positif yang perlu dibangun: jujur, disiplin, bertanggung jawab, dan berempati. Rencanakan masa depan dengan tujuan SMART.",
    ...
    chapters: [
      {
        ...
        emoji: "💫",
        description: "Kenali potensi dirimu dan bangun karakter positif sejak remaja",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            101,
      ...
      },
      {
        ...
        emoji: "📚",
        description: "Kuasai teknik belajar efektif untuk meraih prestasi akademik terbaik",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            201,
      ...
      },
      {
        ...
        emoji: "🚫",
        description: "Kenali bahaya NAPZA, pergaulan bebas, dan cara menghindar dari tekanan negatif",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            301,
      ...
      },
      {
        ...
        emoji: "🏆",
        description: "Pelajari cara membangun karir, mengembangkan soft skill, dan meraih masa depan cerah",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            401,
    ...
    lembarBalik: [
      {
        ...
        emoji: "🌺",
        content: "Kesehatan reproduksi adalah kondisi sehat secara fisik, mental, dan sosial yang berkaitan dengan sistem reproduksi, bukan sekadar bebas dari penyakit.",
        highlight: "Menjaga kesehatan reproduksi adalah hak dan tanggung jawab setiap remaja."
      },
      {
        title: "Perubahan Fisik Saat Pubertas",
        emoji: "💫",
        content: "Perempuan: payudara berkembang, menstruasi pertama, pinggul melebar. Laki-laki: suara membesar, tumbuh jakun, mimpi basah. Semua perubahan ini NORMAL."
      },
      {
        title: "Menjaga Kebersihan Organ Reproduksi",
        emoji: "🚿",
        content: "Tips kebersihan: Bersihkan dengan air bersih dari depan ke belakang (khusus perempuan), ganti pakaian dalam setiap hari, gunakan sabun lembut.",
        highlight: "Kebersihan organ reproduksi adalah bagian dari ibadah dan kesehatan."
      },
      {
        title: "Hubungan Sehat vs Tidak Sehat",
        emoji: "💚",
        content: "Hubungan sehat: saling menghormati, mendukung, berkomunikasi terbuka, menjaga batasan pribadi. Hubungan tidak sehat: ada paksaan, manipulasi, kekerasan."
      },
      {
        title: "Hak Kesehatan Seksual dan Reproduksi",
        emoji: "📖",
        content: "Setiap remaja berhak: mendapat informasi yang benar tentang reproduksi, dilindungi dari kekerasan dan eksploitasi, mendapat layanan kesehatan reproduksi yang aman."
      }
    ],
    chapters: [
      {
        ...
        emoji: "🌺",
        description: "Pahami apa itu kesehatan reproduksi dan pentingnya bagi remaja",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            101,
      ...
      },
      {
        ...
        emoji: "💫",
        description: "Kenali perubahan fisik saat pubertas pada remaja laki-laki dan perempuan",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            201,
      ...
      },
      {
        ...
        emoji: "🚿",
        description: "Pelajari cara menjaga kebersihan organ reproduksi dan keselamatan diri",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            301,
      ...
      },
      {
        ...
        emoji: "🛡️",
        description: "Kenali risiko kehamilan remaja, penyakit menular seksual, dan cara pencegahannya",
        questionsPerPlay: 3,
        questionPool: [
          mc(
            401,
...
function QuizPage({
  ...
  const chapters = mod2.chapters && mod2.chapters.length > 0 ? mod2.chapters : [];
  const chapterQuestions = reactExports.useMemo(() => {
  ...
  const scoresRef = reactExports.useRef(
  ...
  if (phase.type === "chapter-intro") {
    const chIdx2 = phase.chapterIndex;
    const chapter = chapters[chIdx2];
    const questionsInChapter = chapterQuestions[chIdx2];
    const correctSoFar = scoresRef.current.slice(0, chIdx2).reduce((s, cs) => s + cs.correct, 0);
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-[#F3F8FF] px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mb-1", children: chapters.map((ch, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `flex-1 h-2 rounded-full ${i < chIdx2 ? "bg-green-500" : i === chIdx2 ? "bg-yellow-400" : "bg-gray-200"}`
          },
          ch.id
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500 text-right", children: [
          "Bab ",
          chIdx2 + 1,
          " dari ",
          totalChapters
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-lg p-8 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-gray-900 mb-2", children: chapter.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mb-6", children: chapter.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-black text-[#003087]", children: questionsInChapter.length }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-500", children: "Soal" })
          ] }),
          chIdx2 > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-8 bg-gray-200" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-black text-green-600", children: correctSoFar }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-500", children: "Benar Sejauh Ini" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
  ...
  if (phase.type === "chapter-summary") {
    const chIdx2 = phase.chapterIndex;
    const isLast = chIdx2 + 1 >= totalChapters;
    const percentage = Math.round(
      phase.correct / Math.max(phase.total, 1) * 100
    );
    const grade = percentage >= 90 ? "Luar Biasa! 🌟" : percentage >= 70 ? "Bagus! 👍" : percentage >= 50 ? "Cukup Baik 💪" : "Tetap Semangat! 📚";
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-[#F3F8FF] px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-lg p-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "w-20 h-20 rounded-full flex items-center justify-center text-4xl mx-auto mb-4",
          ...
          children: chapters[chIdx2].emoji
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-xl font-black text-gray-900 mb-1", children: [
        "Bab ",
        chIdx2 + 1,
        " Selesai!"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mb-6", children: chapters[chIdx2].title }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "text-5xl font-black mb-2",
          style: { color: mod2.gradientFrom },
          children: [
            percentage,
            "%"
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-bold text-gray-700 mb-1", children: grade }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-500 mb-8", children: [
        "Benar ",
        phase.correct,
        " dari ",
        phase.total,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mb-6", children: chapters.map((ch, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `h-2 rounded-full ${i < chIdx2 ? "bg-green-500" : i === chIdx2 ? "bg-yellow-400" : "bg-gray-200"}`
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 text-center mt-1", children: ch.emoji })
      ] }, ch.id)) }),
      isLast ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        "button",
        {
          type: "button",
          onClick: () => {
            setPhase({ type: "chapter-intro", chapterIndex: chIdx2 + 1 });
  ...
  const handleSelectOption = (index2) => {
    ...
    setAnswered(true);
    const isCorrect = index2 === mappedCorrectIndex;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-[#F3F8FF] px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mb-3", children: chapters.map((ch, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: `flex-1 h-2 rounded-full transition-all ${i < chIdx ? "bg-green-500" : i !== chIdx ? "bg-gray-200" : ""}`,
          style: i === chIdx ? {
            background: `linear-gradient(90deg, ${mod2.gradientFrom}, ${mod2.gradientTo})`
          } : {}
        },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs text-gray-500 mb-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base sm:text-lg font-black text-gray-900 mb-6 leading-snug", children: question.type === "fill-blank" ? question.question.replace("___", "___________") : question.question }),
          question.type === "true-false" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: question.options.map((option, index2) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                disabled: answered,
                className: `flex flex-col items-center justify-center gap-2 p-6 rounded-2xl border-2 transition-all font-black ${style2.bg} ${style2.border} ${style2.text} ${!answered ? "cursor-pointer" : "cursor-default"}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl", children: index2 === 0 ? "✅" : "❌" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base", children: option })
                ]
              },
              `opt-${question.id}-${optionLabels[index2]}`
            );
          }) }),
          (question.type === "multiple-choice" || question.type === "fill-blank") && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: question.options.map((option, index2) => {
            const style2 = getOptionStyle(index2);
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `w-7 h-7 flex-shrink-0 rounded-full flex items-center justify-center text-xs font-black border-2 ${answered && index2 === mappedCorrectIndex ? "bg-green-500 border-green-500 text-white" : answered && index2 === selectedOption && index2 !== mappedCorrectIndex ? "bg-red-400 border-red-400 text-white" : "border-current"}`,
                      children: answered && index2 === mappedCorrectIndex ? "✓" : optionLabels[index2]
                    }
                  ),
          ...
          answered && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: selectedOption === mappedCorrectIndex ? "#f0fdf4" : "#fef2f2",
                borderLeft: `4px solid ${selectedOption === mappedCorrectIndex ? "#22c55e" : "#ef4444"}`
              },
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: selectedOption === mappedCorrectIndex ? "✅" : "❌" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      style: {
                        color: selectedOption === mappedCorrectIndex ? "#166534" : "#991b1b"
                      },
                      children: selectedOption === mappedCorrectIndex ? "Benar! Hebat!" : "Kurang tepat."
                    }
                  ),
    ...
    answered && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end animate-fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: qIdx + 1 >= totalInChapter ? "Selesai Bab ✓" : "Pertanyaan Berikutnya →"
      }
    ) })
  ] }) });
}
